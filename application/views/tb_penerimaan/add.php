    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tb Penerimaan Add</h3>
            </div>
            <?php echo form_open('tb_penerimaan/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="tgl_masuk" class="control-label">Tgl Masuk</label>
						<div class="form-group">
							<input type="text" name="tgl_masuk" value="<?php echo $this->input->post('tgl_masuk'); ?>" class="has-datepicker form-control" id="tgl_masuk" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="penerima" class="control-label">Penerima</label>
						<div class="form-group">
							<input type="text" name="penerima" value="<?php echo $this->input->post('penerima'); ?>" class="form-control" id="penerima" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="kondisi_barang" class="control-label">Kondisi Barang</label>
						<div class="form-group">
							<input type="text" name="kondisi_barang" value="<?php echo $this->input->post('kondisi_barang'); ?>" class="form-control" id="kondisi_barang" />
						</div>
					</div>
					<div class="col-md-6">
