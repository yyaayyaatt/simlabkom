...
class Riwayat_perbaikan_model extends CI_Model
{
    ...
    function get_all_perbaikan($number, $offset)
    {
        ...
        $this->db->join('ruangan f', 'f.id_ruangan=d.id_ruangan', 'left');
    ...
    function get_perawatan($perbaikan)
    {
        ...
        $this->db->join('perbaikan b', 'b.id_perawatan=a.id_perawatan', 'left');
        $this->db->join('asisten d', 'd.id_asisten=a.id_cek', 'left');
        $this->db->join('inventaris e', 'e.id_inventaris=a.id_inventaris', 'left');
        $this->db->join('barang c', 'c.id_barang=e.id_barang', 'left');
        $this->db->join('ruangan f', 'f.id_ruangan=e.id_ruangan', 'left');
